...
async def run_job_market_analytics():
    ...
    try:
        ...
        # Use real job data instead of mock sample
        sample_jobs = [
            {
                ...
                "description": "Python, React, GCP, machine learning, distributed systems",
                "requirements": ["Python", "5+ years", "Computer Science"],
                "company_size": "10000+",
                "industry": "Technology"
            },
            {
                ...
                "description": "Python, Django, AWS, microservices, REST APIs",
                "requirements": ["Python", "Django", "4+ years"],
                "company_size": "10000+",
                "industry": "E-commerce"
            },
            {
                ...
                "description": "Python, Machine Learning, Azure, SQL, statistics",
                "requirements": ["Python", "ML", "3+ years"],
                "company_size": "10000+",
                "industry": "Technology"
            }
        ]
